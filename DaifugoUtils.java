...
public class DaifugoUtils {
    ...
    // 手札から場に出すカードを選択する
    public static List<String> selectHand() {
    ...
    // 文字列からカードに変換。プレイヤーが持ってなかったらnullを返す。
    ...
    public static String getNumber(Card card) {
        ...
        card.setJokerValue(99);     // Jokerの値を初期化
        return number;
    }
